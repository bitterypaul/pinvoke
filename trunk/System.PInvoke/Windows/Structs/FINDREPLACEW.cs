...
{
    /// <summary>
    /// The FINDREPLACEW structure contains information that the FindText and ReplaceText functions 
    ...
    public struct FindReplaceW
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.LPWStr)] public string lpstrFindWhat;
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.LPWStr)] public string lpstrReplaceWith;
