...
{
    /// <summary>
    /// Specifies the language in which to display the text contained in the predefined 
    /// push buttons. This value must be in the form returned by the MAKELANGID macro. 
    /// </summary>
