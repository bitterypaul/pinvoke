...
namespace System.PInvoke.Windows.Structs
{
    ...
    public struct PageSetupDlgW
    {
        ...
        /// <summary>
        /// Handle to a global memory object that contains a DEVMODEW structure. On input,
        /// if a handle is specified, the values in the corresponding DEVMODEW structure are
        /// used to initialize the controls in the dialog box. On output, the dialog box sets
        /// hDevMode to a global memory handle to a DEVMODEW structure that contains values 
        ...
        /// member. 
        /// </summary>
        [MarshalAs(UnmanagedType.LPWStr)] public string lpPageSetupTemplateName;
