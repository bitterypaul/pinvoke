...
{
    /// <summary>
    /// The LPPRINTHOOKPROC type defines a pointer to an application-defined or library-defined 
    /// callback function that is used with the PrintDlg function. The function receives messages or 
    /// notifications intended for the default dialog box procedure of the Print dialog box.
    /// </summary>
    /// <param name="hdlg">Handle to the Print dialog box for which the message is intended</param>
    ...
    /// If the uiMsg parameter indicates the WM_INITDIALOG message, lParam is a pointer to a PRINTDLG
    ...
    public delegate uint LpPrintHookProc(IntPtr hdlg, uint uiMsg, IntPtr wParam, IntPtr lParam);
}